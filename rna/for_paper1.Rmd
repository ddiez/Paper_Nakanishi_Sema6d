...
```{r}
ggsave(here("rna/figures/fig6F.pdf"), width=5, height=5)
```
...
```{r}
ggsave(here("rna/figures/figS6C.pdf"), width=10, height=6)
```

# fig 6G: UMAP of conditions
...
```{r}
ggsave(here("rna/figures/fig6G.pdf"), width=10, height=5)
```

# fig S6D: Cell composition
...
```{r}
ggsave(here("rna/figures/figS6D.pdf"), width=3, height=3)
```

# fig S6E: KO vs. WT DEGs barplot
...
```{r}
ggsave(here("rna/figures/figS6E.pdf"), width=4, height=2)
```

# fig S6F: Violin plot Sema6d, Plxn4a in WT
...
```{r}
ggsave(here("rna/figures/figS6F.pdf"), width=6, height=5)
```

# fig 6I: Cell-cell interaction: celltype.l0
...
```{r}
pdf(here("rna/figures/fig6I.pdf"), width=6.5, height=3)
p
dev.off()
```

# fig 6J: Cell-cell interaction: label
...
```{r}
pdf(here("rna/figures/fig6J.pdf"), width=4, height=4)
p
dev.off()
```

# fig 6K: BLA-CeA distribution
...
```{r}
ggsave(here("rna/figures/fig6K.pdf"), width=8, height=4)
```
